...
<meta name="author" content="http://www.foresee.com/"/>
...
<link href="${ctxStatic}/uimaker/green/css/basic_info.css" rel="stylesheet">
...
<script src="${ctxStatic}/ztree/jquery.ztree.all.min.js"></script>
<script src="${ctxStatic}/jquery-easyui-1.5/jquery.easyui.all.js"></script>
<script src="${ctxStatic}/jquery-easyui-1.5/jquery.edatagrid.js" type="text/javascript"></script>	
<script src="${ctxStatic}/jquery-easyui-1.5/locale/easyui-lang-zh_CN.js"></script>
